  ...
  return (
    ...
    <View style={styles.container}>
        <View style={[styles.viewTextInput, {marginTop: 123}]}>
          <TextInput style={styles.textInput} onChangeText={(firstName) => setFirstName(firstName)} placeholder='Enter first name' autoCapitalize='words' keyboardType='default' />
        </View>
        <View style={[styles.viewTextInput, {marginTop: 11}]}>
          <TextInput style={styles.textInput} onChangeText={(lastName) => setLastName(lastName)} placeholder='Enter last name' autoCapitalize='words' keyboardType='default' />
        </View>
        <View style={[styles.viewTextInput, {marginTop: 11}]}>
